...
| Tab | What it does |
|-----|--------------|
| **Ask** | Hybrid BM25 ⊕ vector retrieval over indexed 3GPP specs, Nemotron-3 synthesis (configurable model chain; Lightning-first with Nano fallback in this demo), deterministic citation validator (verbatim-quote fuzzy match ≥95) |
...
LanceDB index is expected at `data/index/` (downloaded file-by-file from a
gated HF dataset at boot).
